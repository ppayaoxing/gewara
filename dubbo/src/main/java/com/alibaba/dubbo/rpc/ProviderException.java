...
public final class ProviderException extends RuntimeException {
    ...
    public ProviderException(Throwable cause) {
        //super(cause);
    	super(cause.getClass().getCanonicalName());
    }

    public ProviderException(int code) {
        super();
        this.code = code;
    }
    ...
    public ProviderException(int code, String message) {
        super(message);
        this.code = code;
    }

    public ProviderException(int code, Throwable cause) {
        //super(cause);
    	super(cause.getClass().getCanonicalName());
        this.code = code;
    }
