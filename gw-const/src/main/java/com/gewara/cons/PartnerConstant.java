...
public class PartnerConstant {
	...
	public static final Long WEIXIN = 50000012L;				//微信 Wap版
	public static final Long IPHONE = 50000070L;				//iphone手机客户端
	public static final Long IPHONE_FILM = 50000071L;				//iphone手机(电影节)客户端
	...
	public static final Long GEWA_WOMOVIE_PC = 50000089L;	//联通定制网页版
	public static final Long GEWA_WOMOVIE_ANDROID = 50000092L;	//联通定制版
	public static final Long GEWA_WOMOVIE_IOS = 50000093L;		//联通定制版
	...
	public static final Long MIN_PARTNERID = 50000000L;			//介于此值的是partner
	public static final Long MAX_PARTNERID = 51000000L;			//介于此值的是partner
	...
	public static final Long PARTNER_WEIPIAO = 50000119L;
...
*/
	...
	public static boolean isOutPartner(Long memberid){//外部商家
		return memberid >= PartnerConstant.MIN_PARTNERID && memberid <= PartnerConstant.MAX_PARTNERID;
	}
	public static boolean isGewaPartner(Long memberid, Long partnerid){//内部WAP,IPHONE...
		return partnerid>1 && (memberid < PartnerConstant.MIN_PARTNERID || memberid > PartnerConstant.MAX_PARTNERID);
	}
	public static boolean isGewaMember(Long memberid){//内部WAP,IPHONE...
		return memberid < PartnerConstant.MIN_PARTNERID || memberid > PartnerConstant.MAX_PARTNERID;
	}
	public static boolean isDisneyPartner(Long memberid){
		return PartnerConstant.PARTNER_DISNEY_PC.equals(memberid) || PartnerConstant.PARTNER_DISNEY_WAP.equals(memberid);
	}
}
