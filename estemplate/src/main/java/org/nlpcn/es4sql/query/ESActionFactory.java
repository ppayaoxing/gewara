...
public class ESActionFactory {
	...
	public static QueryAction create(Client client, String sql) throws SqlParseException, SQLFeatureNotSupportedException {
        ...
        switch (firstWord.toUpperCase()) {
            ...
            case "UPDATE":
				parser = SQLParserUtils.createSQLStatementParser(sql, JdbcUtils.MYSQL);
				SQLUpdateStatement updateStatement = parser.parseUpdateStatement();
				Update update = new SqlParser().parseUpdate(updateStatement);
				return new UpdateQueryAction(client,update,sql);
			default:
