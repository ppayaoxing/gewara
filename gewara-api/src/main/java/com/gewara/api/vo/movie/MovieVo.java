...
public class MovieVo extends BaseEntityVo implements Comparable<MovieVo> {
	...
	private Integer mcpCount; // 影片时长：以分钟为单位
	...
	/***
	 * 本次1=(本次*2到3之间的随机数)； 1、 购票人次= 上次购票+本次1 2、 想看人次= 实际想看人数； 3、 看过人次= 实际看过人数+本次1；
	 * 4、 感兴趣人次= 实际点击感兴趣人次+想看人次； 5、 浏览数= 上次浏览次数+本次1； 6、 参与评分人= (实际参与评分人次+购票人次)/2；
	 * 
	 **/
