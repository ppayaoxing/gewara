...
public interface MongoService {
	 ...
	 * @return
	 */
	<T extends MGObject> List<T> getObjectList(Class<T> clazz1, Expression params, String orderField, boolean asc,
			int from, int maxnum);
	...
	<T extends MGObject> List<T> find(Class<T> clazz, Map hashMap);

	List<Map> find(String namespace, Expression params);

	List<Map> find(String namespace, DBObject params);
	...
	List<Map> find(String namespace, Map params, int from, int maxnum);

	List<Map> find(String namespace, Expression params, String orderField, boolean asc, int from, int maxnum);
	List<Map> find(String namespace, DBObject params, String orderField, boolean asc, int from, int maxnum);
	...
	int getCount(String namespace, DBObject params);
	...
	int removeObjectList(String namespace, Map params);

	int removeObjectList(String namespace, DBObject params);
	 ...
	 * @param c
	 */
	void saveOrUpdateMapList(List<Map> mapList, String string, String string2, boolean b, boolean c);
	 ...
	 * @param c
	 */
	void saveOrUpdateMap(Map map, String string, String string2, boolean b, boolean c);
	...
	DBObject queryAdvancedDBObject(String string, Object[] strings, Object[] dates);
	...
	List<Map> find(String canonicalName, Map paramsMap, String[] orderField, boolean[] asc, int from, int maxnum);
	...
	String getPrimitiveObject(String keyFixedkeywords);

	void update(String namespace, Map data, Map destMap);
