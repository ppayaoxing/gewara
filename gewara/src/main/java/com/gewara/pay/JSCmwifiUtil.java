 ...
 *
 */
public class JSCmwifiUtil {
	private static final transient GewaLogger dbLogger = LoggerUtils.getLogger(JSCmwifiUtil.class, Config.getServerIp(), Config.SYSTEMID);
