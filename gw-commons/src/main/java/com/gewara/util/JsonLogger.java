...
import com.gewara.util.LogMessage;
...
public class JsonLogger extends LoggerWrapper implements Logger, GewaLogger {
	...
	public void throwing(JsonLogger.Level level, Throwable throwable) {
		if (this.instanceofLAL) {
	...
	public void catching(JsonLogger.Level level, Throwable throwable) {
		if (this.instanceofLAL) {
	...
	public void warn(String msg, Throwable t) {
		LogMessage logMsg = new LogMessage((String) null, server, systemId, msg, t);
	...
	public void warn(String msg) {
		LogMessage logMsg = new LogMessage((String) null, server, systemId, msg);
		msg = logMsg.getDataStr();
		if (this.logger.isWarnEnabled()) {
			if (this.instanceofLAL) {
				((LocationAwareLogger) this.logger).log((Marker) null, FQCN, 30, msg, (Object[]) null,
	...
	public void warnMap(Map msgMap) {
		LogMessage logMsg = new LogMessage((String) null, server, systemId, msgMap);
		String msg = logMsg.getDataStr();
		if (this.logger.isWarnEnabled()) {
			if (this.instanceofLAL) {
				((LocationAwareLogger) this.logger).log((Marker) null, FQCN, 30, msg, (Object[]) null,
