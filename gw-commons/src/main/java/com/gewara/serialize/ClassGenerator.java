...
public final class ClassGenerator {
	...
	public Class<?> toClass(ClassLoader loader, ProtectionDomain pd) {
		...
		try {
			...
			String code;
			if (this.mInterfaces != null) {
				arg5 = this.mInterfaces.iterator();

				while (arg5.hasNext()) {
					code = (String) arg5.next();
					this.mCtc.addInterface(this.mPool.get(code));
				}
			}

			if (this.mFields != null) {
				arg5 = this.mFields.iterator();
			...
			if (this.mConstructors != null) {
				arg5 = this.mConstructors.iterator();
		...
		} catch (CannotCompileException arg10) {
