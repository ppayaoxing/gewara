...
public interface Dao {
	...
	<T extends BaseObject, S extends Serializable> Map getObjectPropertyMap(Class<T> clazz, String keyname,
	 ...
	 * 
	 * @param clazz
	 *            查询对象，如:TicketOrder.class
	 * @param ukeyName
	 *            字段名，如：tradeNo
	 * @param ukeyvalue
	 *            字段值，如：1091023141727057
	 * @return
	 */
	 ...
	 * @return
	 */
	<T extends BaseObject, S extends Serializable> List<T> getObjectBatch(Class<T> clazz, String propertyName,
