...
public abstract class UploadUtil {
	...
	public static String writeCKUploadRes(HttpServletResponse response, String uploadPath, 
			Long userid, String callback, String successFile, String msg, String tag, Long relatedid) throws IOException{
	...
	public static String writeCKUploadRes(HttpServletResponse response, String uploadPath, 
			Long userid, String callback, String successFile, String msg, String tag, Long relatedid, String dstPath) throws IOException{
	...
	public static boolean moveFilesTo(String uploadPath, Long userid, String dstPath, String files, String tag, Long relatedid){
