 ...
 * 
 * Provides a custom connection validation mechanism for Postgres dbVendor if
 * custom-validation is chosen as the connection-validation-method.
 * 
 * @author Shalini M
 */
public class GWMysqlConnValidation  {
	private static final String SQL = "SELECT 1 as bb";
